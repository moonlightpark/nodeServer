...
var server = app.listen(port, function(){
    console.log(`Express Developer(doraemon01) server has started on port ${port}`)
})
...
// 이더송금
// method post
// request {from:address, to:address, balance:1, n:nonce, key:privateKey}
// response {error:boolean, hash:txhash}
...
// erc20 토큰 송금
// method post
// request {from:address, to:address, token:contractAddress, balance:1, n:nonce, key:privateKey}
// response {error:boolean, hash:txhash}
